...
import { Button, styled as styled$3, TextField, Box, InputLabel, IconButton, FormControl, Select, MenuItem, InputAdornment, Tooltip, List, ListItemButton, ListItemIcon, ListItemText, Drawer, ListItem, Typography as Typography$1, Tab as Tab$1, Divider, Avatar, Tabs, OutlinedInput, Switch, Modal, Container, Stepper, Step, Accordion, AccordionSummary, AccordionDetails, Chip, FormGroup, FormControlLabel, Checkbox, checkboxClasses, TableSortLabel, TableContainer, TableFooter } from '@mui/material';
import { GroupsOutlined, UnfoldLessOutlined, CloseOutlined, UploadOutlined, UnfoldMoreOutlined, ThumbUpAltOutlined, ThumbDownAltOutlined, StarBorderPurple500Outlined, StarPurple500Outlined, RemoveOutlined, MenuOutlined, InfoOutlined, HelpOutlineOutlined, CardGiftcardOutlined, VisibilityOutlined, SentimentNeutralOutlined, SentimentSatisfiedOutlined, SentimentVerySatisfiedOutlined, SearchOutlined, DownloadOutlined, MoreVertOutlined, MoreHorizOutlined, CreditCardOutlined, PersonSearchOutlined, SettingsOutlined, HighlightOffOutlined, Cancel, Circle, KeyboardArrowUpOutlined, KeyboardArrowRightOutlined, KeyboardArrowLeftOutlined, KeyboardControlKeyOutlined, KeyboardArrowDownOutlined, KeyboardDoubleArrowRightOutlined, KeyboardDoubleArrowLeftOutlined, CheckCircle, CheckCircleOutline, Check, DoDisturbOutlined, InsertInvitationOutlined, NotificationsNoneOutlined, Inventory2Outlined, Inventory, WarningAmber, RestartAlt, ReportGmailerrorred, ErrorOutline, Error as Error$2, ArrowForwardIos, ArrowForward, ArrowBack, ArrowBackIos, Delete, Mode, Add, ExpandLess, ExpandMore, ModeOutlined, DeleteOutlineOutlined } from '@mui/icons-material';
import emStyled from '@emotion/styled';
import '@emotion/react';
import * as React from 'react';
import React__default, { useRef, useState, useEffect, useMemo, useLayoutEffect, createElement, forwardRef, useImperativeHandle, useCallback } from 'react';
import SearchOutlinedIcon from '@mui/icons-material/SearchOutlined';
import ErrorIcon from '@mui/icons-material/Error';
import Alert from '@mui/material/Alert';
import AlertTitle from '@mui/material/AlertTitle';
import Snackbar from '@mui/material/Snackbar';
import { useTheme, styled as styled$4 } from '@mui/material/styles';
import SearchIcon$1 from '@mui/icons-material/Search';
...
var Icon = function (_a) {
    ...
    var buttonIcon = function (iconName) {
        ...
        if (type === IconType.MUI) {
            switch (iconName) {
                case ICONS.ADD:
                    return jsx(Add, { fontSize: "small", style: customStyle() });
                case ICONS.CREATEICON:
                    return jsx(Mode, { style: customStyle() });
                case ICONS.DELETE:
                    return jsx(Delete, { fontSize: "small", style: customStyle() });
                case ICONS.ARROWBACKIOS:
                    return jsx(ArrowBackIos, { fontSize: "small", style: customStyle() });
                case ICONS.ARROWBACK:
                    return jsx(ArrowBack, { fontSize: "small", style: customStyle() });
                case ICONS.ARROWFORWARD:
                    return jsx(ArrowForward, { fontSize: "small", style: customStyle() });
                case ICONS.ARROWFORWARDIOS:
                    return jsx(ArrowForwardIos, { fontSize: "small", style: customStyle() });
                case ICONS.ERROR:
                    return jsx(Error$2, { fontSize: "small", style: customStyle() });
                case ICONS.ERROROUTLINE:
                    return jsx(ErrorOutline, { fontSize: "small", style: customStyle() });
                case ICONS.REPORTGMAILERROR:
                    return jsx(ReportGmailerrorred, { fontSize: "small", style: customStyle() });
                case ICONS.RESETICON:
                    return jsx(RestartAlt, { fontSize: "small", style: customStyle() });
                case ICONS.WARNINGAMBER:
                    return jsx(WarningAmber, { fontSize: "small", style: customStyle() });
                case ICONS.INVENTORY:
                    return jsx(Inventory, { fontSize: "small", style: customStyle() });
                case ICONS.INVENTORYOUTLINE:
                    return jsx(Inventory2Outlined, { fontSize: "small", style: customStyle() });
                case ICONS.NOTIFICATIONOUTLINE:
                    return (jsx(NotificationsNoneOutlined, { fontSize: "small", style: customStyle() }));
                case ICONS.INVITATION:
                    return (jsx(InsertInvitationOutlined, { fontSize: "small", style: customStyle() }));
                case ICONS.CANCELICON:
                    return jsx(DoDisturbOutlined, { fontSize: "small", style: customStyle() });
                case ICONS.CHECK:
                    return jsx(Check, { fontSize: "small", style: customStyle() });
                case ICONS.CHECKOUTLINE:
                    return jsx(CheckCircleOutline, { fontSize: "small", style: customStyle() });
                case ICONS.CHECKCIRCLE:
                    return jsx(CheckCircle, { fontSize: "small", style: customStyle() });
                case ICONS.DOUBLEARROWLEFT:
                    return (jsx(KeyboardDoubleArrowLeftOutlined, { fontSize: "small", style: customStyle() }));
                case ICONS.DOUBLEARROWRIGHT:
                    return (jsx(KeyboardDoubleArrowRightOutlined, { fontSize: "small", style: customStyle() }));
                case ICONS.ARROWDOWN:
                    return (jsx(KeyboardArrowDownOutlined, { fontSize: "small", style: customStyle() }));
                case ICONS.ARROWTOP:
                    return (jsx(KeyboardControlKeyOutlined, { fontSize: "small", style: customStyle() }));
                case ICONS.ARROWLEFT:
                    return (jsx(KeyboardArrowLeftOutlined, { fontSize: "small", style: customStyle() }));
                case ICONS.ARROWRIGHT:
                    return (jsx(KeyboardArrowRightOutlined, { fontSize: "small", style: customStyle() }));
                case ICONS.ARROWUP:
                    return (jsx(KeyboardArrowUpOutlined, { fontSize: "small", style: customStyle() }));
                case ICONS.CIRCLE:
                    return jsx(Circle, { fontSize: "small", style: customStyle() });
                case ICONS.CANCEL:
                    return jsx(Cancel, { fontSize: "small", style: customStyle() });
                case ICONS.CANCELOUTLINE:
                    return (jsx(HighlightOffOutlined, { fontSize: "small", style: customStyle() }));
                case ICONS.SETTINGSICON:
                    return jsx(SettingsOutlined, { fontSize: "small", style: customStyle() });
                case ICONS.PERSONSEARCH:
                    return (jsx(PersonSearchOutlined, { fontSize: "small", style: customStyle() }));
                case ICONS.CREDITCARD:
                    return jsx(CreditCardOutlined, { fontSize: "small", style: customStyle() });
                case ICONS.DOTSHORIZOUTLINE:
                    return jsx(MoreHorizOutlined, { fontSize: "small", style: customStyle() });
                case ICONS.DOTSVERTLINE:
                    return jsx(MoreVertOutlined, { fontSize: "small", style: customStyle() });
                case ICONS.DOWNLOADICON:
                    return jsx(DownloadOutlined, { fontSize: "small", style: customStyle() });
                case ICONS.SEARCHIOCN:
                    return jsx(SearchOutlined, { fontSize: "small", style: customStyle() });
                case ICONS.EMOEXCITED:
                    return (jsx(SentimentVerySatisfiedOutlined, { fontSize: "small", style: customStyle() }));
                case ICONS.EMOSATISFIED:
                    return (jsx(SentimentSatisfiedOutlined, { fontSize: "small", style: customStyle() }));
                case ICONS.EMONEUTRAL:
                    return (jsx(SentimentNeutralOutlined, { fontSize: "small", style: customStyle() }));
                case ICONS.VISIBILITY:
                    return jsx(VisibilityOutlined, { fontSize: "small", style: customStyle() });
                case ICONS.GIFTCARD:
                    return (jsx(CardGiftcardOutlined, { fontSize: "small", style: customStyle() }));
                case ICONS.HELPCERCLE:
                    return jsx(HelpOutlineOutlined, { fontSize: "small", style: customStyle() });
                case ICONS.INFOOUTLINE:
                    return jsx(InfoOutlined, { fontSize: "small", style: customStyle() });
                case ICONS.MENUOUTLINE:
                    return jsx(MenuOutlined, { fontSize: "small", style: customStyle() });
                case ICONS.REMOVEICON:
                    return jsx(RemoveOutlined, { fontSize: "small", style: customStyle() });
                case ICONS.STARICON:
                    return (jsx(StarPurple500Outlined, { fontSize: "small", style: customStyle() }));
                case ICONS.STARICONPLUS:
                    return (jsx(StarBorderPurple500Outlined, { fontSize: "small", style: customStyle() }));
                case ICONS.THUMBDOWN:
                    return (jsx(ThumbDownAltOutlined, { fontSize: "small", style: customStyle() }));
                case ICONS.THUMBUP:
                    return jsx(ThumbUpAltOutlined, { fontSize: "small", style: customStyle() });
                case ICONS.UNFOLDMORE:
                    return jsx(UnfoldMoreOutlined, { fontSize: "small", style: customStyle() });
                case ICONS.UPLOADICON:
                    return jsx(UploadOutlined, { fontSize: "small", style: customStyle() });
                case ICONS.WINDOWCLOSE:
                    return jsx(CloseOutlined, { fontSize: "small", style: customStyle() });
                case ICONS.UNFOLDLESSICON:
                    return jsx(UnfoldLessOutlined, { fontSize: "small", style: customStyle() });
                case ICONS.GROUPOUTLINE:
                    return jsx(GroupsOutlined, { fontSize: "small", style: customStyle() });
            }
        }
        else {
            switch (iconName) {
                case ICONS.ATOM:
                    return jsx(Atom, { color: color, side: side });
                case ICONS.CLOCK:
                    return jsx(Clock, { color: color, side: side });
                case ICONS.EMOCONFUSED:
                    return jsx(EmoConfused, { color: color, side: side });
                case ICONS.EMOCRY:
                    return jsx(EmoCry, { color: color, side: side });
                case ICONS.FILTEROUTLINE:
                    return jsx(FilterOutline, { color: color, side: side });
                case ICONS.FINANCEOUTLINE:
                    return jsx(FinanceOutline, { color: color, side: side });
                case ICONS.HANDSHAKE:
                    return jsx(HandShake, { color: color, side: side });
                case ICONS.SHIELDACCOUNT:
                    return jsx(ShieldAccount, { color: color, side: side });
                case ICONS.TEXTBOXEDIT:
                    return jsx(TextBoxEdit, { color: color, side: side });
                case ICONS.TRASHICON:
                    return jsx(TrashICon, { color: color, side: side });
                case ICONS.RELOADICON:
                    return jsx(ReloadIcon, { color: color, side: side });
                case ICONS.ADDACCOUNT:
                    return jsx(AddAccount, { color: color, side: side });
                case ICONS.LOCKACCOUNT:
                    return jsx(LockAccount, { color: color, side: side });
                case ICONS.BELLHORNICON:
                    return jsx(BellHornIcon, { color: color, side: side });
                case ICONS.CHEVRONLEFT:
                    return jsx(ChevronLeft, { color: color, side: side });
                case ICONS.CHEVRONRIGHT:
                    return jsx(ChevronRight, { color: color, side: side });
                case ICONS.SUMMARY:
                    return jsx(Summary, { color: color, side: side });
                case ICONS.ANALYTICS:
                    return jsx(Analytics, { color: color, side: side });
                case ICONS.BULLHORN:
                    return jsx(BullHorn, { color: color, side: side });
                case ICONS.USERLOCK:
                    return jsx(UserLock, { color: color, side: side });
                case ICONS.IGNITE:
                    return jsx(Ignite, { color: color, side: side });
                case ICONS.PULSE:
                    return jsx(Pulse, { color: color, side: side });
                case ICONS.AMPLIFY:
                    return jsx(Amplify, { color: color, side: side });
                case ICONS.REPORTING:
                    return jsx(Reporting, { color: color, side: side });
                case ICONS.PLATFORMFACEBOOK:
                    return jsx(PlatformFaceBook, { color: color, side: side });
                case ICONS.PLATFORMBING:
                    return jsx(PlatformBing, { color: color, side: side });
                case ICONS.PLATFORMGOOGLEADS:
                    return jsx(PlatformGoogleAds, { color: color, side: side });
                case ICONS.INSPIRE:
                    return jsx(Inspire, { color: color, side: side });
                case ICONS.KPIICONS:
                    return jsx(KPIIcons, { color: color, side: side });
                case ICONS.CUSTOMERTRENDS:
                    return jsx(CustomerTrends, { color: color, side: side });
                case ICONS.CUSTOMERFLOWS:
                    return jsx(CustomerFlows, { color: color, side: side });
                case ICONS.DIAGNOSE:
                    return jsx(Diagnose, { color: color, side: side });
                case ICONS.SCHEDULER:
                    return jsx(Scheduler, { color: color, side: side });
            }
        }
    };
    return jsx(Fragment, { children: buttonIcon(iconName) });
};
...
var KpButton = function (_a) {
    ...
    var ButtonComponent = styled$1(Button)(__assign({ fontFamily: "Inter", fontWeight: "600", fontSize: "14px", letterSpacing: "1px", padding: size === "small" ? "6px 12px" : "8px 16px", minWidth: size === "small" ? "81px" : "97px", boxShadow: "none" }, styleOptions(variant, buttonColor, disabled)));
    return (jsxs(ButtonComponent, __assign({}, props, { variant: checkVariant(variant), disabled: disabled }, { children: [hasLeftIcon && leftIcon && (jsx(Icon, { iconName: leftIcon, iconSize: leftIconSize && leftIconSize, side: IconSide.LEFtSIDE, color: iconColor, type: leftIconType })), label, hasRightIcon && rightIcon && (jsx(Icon, { iconName: rightIcon, iconSize: rightIconSize && rightIconSize, side: IconSide.RIGHTSIDE, color: iconColor, type: rightIconType }))] })));
};
...
var TextInput = styled$3(TextField)({
    width: "100%",
    fontSize: "14px",
    fontFamily: "Inter",
...
var SearchIcon = styled$3(SearchOutlinedIcon)({
    fontSize: "18px",
});
var Error$1 = styled$3(ErrorIcon)({
    color: "#C64343",
    fontSize: "18px",
});
var Wrapper = styled$3(Box)({
    display: "block",
    width: "100%",
    marginTop: "4px",
});
var CounterLabel = styled$3(InputLabel)({
    float: "right",
    fontFamily: "Inter",
    fontSize: "12px",
});
var FieldLabel$1 = styled$3(InputLabel)({
    textAlign: "left",
    fontSize: "12px",
    paddingBottom: "4px",
    fontFamily: "Inter",
});
var HelperLabel$1 = styled$3(InputLabel)({
    float: "left",
    fontSize: "12px",
    fontFamily: "Inter",
});
...
var KpFormInput = function (_a) {
    ...
    var _d = useState(0), textCount = _d[0], setTextCount = _d[1];
    var _e = useState(false), focused = _e[0], setFocused = _e[1];
    var _f = useState(typeof defaultValue !== "undefined" ? defaultValue : ""), value = _f[0], setValue = _f[1];
    ...
    return (jsxs(Fragment, { children: [hasLabel && (jsx(FieldLabel$1, __assign({ sx: isMandatory
                    ? {
                    ...
                    : {
                        color: focused ? "#9E9E9E" : "#9E9E9E",
                    } }, { children: label }))), isNumberInput ? (jsx(NumericFormat, __assign({ value: value, thousandSeparator: ",", customInput: TextInput }, props, (register ? __assign({}, register) : { ref: inputRef }), { disabled: disabled, inputProps: { maxLength: maxChars }, onChange: function (e) { return changeItem(e); }, id: "search", size: size, variant: "outlined", onFocus: function () { return setFocused(true); }, placeholder: placeholder, sx: __assign({}, styles), InputProps: {
                    endAdornment: (jsxs(Fragment, { children: [hasIcon && (jsx(IconButton, __assign({ disabled: disabled, onClick: onClick && onClick }, { children: jsx(SearchIcon, {}) }))), errorIcon && error && jsx(Error$1, {})] })),
                }, InputLabelProps: { sx: { color: color, fontSize: "14px" } } }))) : (jsx(TextInput, __assign({}, props, (register ? __assign({}, register) : { ref: inputRef }), { disabled: disabled, inputProps: { maxLength: maxChars }, onChange: function (e) { return changeItem(e); }, id: "search", size: size, variant: "outlined", onFocus: function () { return setFocused(true); }, value: value, placeholder: placeholder, sx: __assign({}, styles), InputProps: {
                    endAdornment: (jsxs(Fragment, { children: [hasIcon && (jsx(IconButton, __assign({ disabled: disabled, onClick: onClick && onClick }, { children: jsx(SearchIcon, {}) }))), errorIcon && error && jsx(Error$1, {})] })),
                }, InputLabelProps: { sx: { color: color, fontSize: "14px" } } }))), hasHelperText && (jsxs(Wrapper, { children: [jsx(HelperLabel$1, __assign({ sx: { color: color } }, { children: helperText })), hasCharCount && (jsxs(CounterLabel, __assign({ sx: { color: color } }, { children: [textCount, "/", maxChars] })))] }))] }));
};
...
var KpAlert = function (_a) {
    ...
    var _b = useState(true), showing = _b[0], setShowing = _b[1];
    ...
    var AlertComponent = styled$1(Alert)({
        background: '#F4F4F6',
    ...
    return (jsx(Fragment, { children: showing ?
            jsx(Fragment, { children: onCloseHandler ?
                    jsxs(Fragment, { children: [hasIconStatus ?
                                jsxs(AlertComponent, __assign({}, props, { severity: status, onClose: function () { setShowing(false); } }, { children: [hasTitleStatus ? jsx(AlertTitle, { children: title }) : null, content] }))
                                :
                                    jsxs(AlertComponent, __assign({}, props, { severity: status, onClose: function () { setShowing(false); }, icon: hasIconStatus }, { children: [hasTitleStatus ? jsx(AlertTitle, { children: title }) : null, content] })), " "] })
                    :
                        jsx(Fragment, { children: hasIconStatus ?
                                jsxs(AlertComponent, __assign({}, props, { severity: status }, { children: [hasTitleStatus ? jsx(AlertTitle, { children: title }) : null, content] }))
                                :
                                    jsxs(Alert, __assign({}, props, { icon: hasIconStatus, severity: status }, { children: [hasTitleStatus ? jsx(AlertTitle, { children: title }) : null, content] })) }) })
            : null }));
};
...
var KpSnackbar = function (_a) {
    ...
    return (jsx(Fragment, { children: showing ? jsx(Fragment, { children: onCloseHandler ?
                jsx(Fragment, { children: hasIconStatus ?
                        jsx(Snackbar, __assign({ open: open, anchorOrigin: { vertical: vertical, horizontal: horizontal }, autoHideDuration: duration, onClose: handleClose }, { children: jsxs(AlertComponent, __assign({ onClose: function () { setShowing(false); }, severity: severityCurrent }, { children: [hasTitleStatus ? jsx(AlertTitle, { children: title }) : null, content] })) }))
                        :
                            jsx(Snackbar, __assign({ open: open, anchorOrigin: { vertical: vertical, horizontal: horizontal }, autoHideDuration: duration, onClose: handleClose }, { children: jsxs(AlertComponent, __assign({ onClose: function () { setShowing(false); }, icon: hasIconStatus, severity: severityCurrent }, { children: [hasTitleStatus ? jsx(AlertTitle, { children: title }) : null, content] })) })) }) :
                jsx(Fragment, { children: hasIconStatus ?
                        jsx(Snackbar, __assign({ open: open, anchorOrigin: { vertical: vertical, horizontal: horizontal }, autoHideDuration: duration, onClose: handleClose }, { children: jsxs(AlertComponent, __assign({ severity: severityCurrent }, { children: [hasTitleStatus ? jsx(AlertTitle, { children: title }) : null, content] })) }))
                        :
                            jsx(Snackbar, __assign({ open: open, anchorOrigin: { vertical: vertical, horizontal: horizontal }, autoHideDuration: duration, onClose: handleClose }, { children: jsxs(AlertComponent, __assign({ icon: hasIconStatus, severity: severityCurrent }, { children: [hasTitleStatus ? jsx(AlertTitle, { children: title }) : null, content] })) })) }) })
            : null }));
};

var FormControlWrapper = styled$3(FormControl)({
    width: "100%",
});
var SelectField = styled$3(Select)({
    width: '100%',
    fontSize: '14px',
    textAlign: 'start',
    fontFamily: "Inter",
...
var SelectMenuItem = styled$3(MenuItem)({
    fontFamily: "Inter",
    fontSize: '12px'
});
var FieldLabel = styled$3(InputLabel)({
    textAlign: 'left',
    fontSize: '12px',
    paddingBottom: '4px',
    fontFamily: "Inter"
});
var HelperLabel = styled$3(InputLabel)({
    float: 'left',
    fontSize: '12px',
    paddingTop: '4px',
    fontFamily: "Inter"
});
var Placeholder = styled$3(InputLabel)({
    float: 'left',
    fontSize: '12px',
    fontFamily: "Inter"
});
...
var InputField = styled$3(TextField)({
    width: '98%',
    margin: '10px',
    fontSize: '14px',
});
...
var KpFormSelect = function (_a) {
    ...
    var displayedOptions = useMemo(function () { return data.filter(function (option) { return containsText(option, searchText); }); }, [searchText]);
    ...
    return (jsxs(Fragment, { children: [hasLabel && (jsx(FieldLabel, __assign({ sx: isMandatory
                    ? {
                        color: focused ? "#9E9E9E" : "#9E9E9E",
                        "&::after": { content: '"*"', color: isMandatoryColor },
                    }
                    : {
                        color: focused ? "#9E9E9E" : "#9E9E9E",
                    } }, { children: label }))), jsx(FormControlWrapper, __assign({ variant: "outlined", required: isMandatory }, { children: jsxs(SelectField, __assign({}, (register ? __assign({}, register) : { ref: selectRef }), { onFocus: function () { return setFocused(true); }, displayEmpty: true, disabled: disabled, value: Option, onChange: handleChange, renderValue: function (selected) {
                        if (selected.length === 1) {
                            return selected.join(', ');
                        }
                        return jsx(Placeholder, { children: placeholder });
                    } }, { children: [withSearch &&
                            jsx(InputField, { size: "small", autoFocus: true, placeholder: searchFieldPlaceholder, fullWidth: true, inputProps: {
                                    startAdornment: (jsx(InputAdornment, __assign({ position: "start" }, { children: jsx(SearchIcon$1, {}) })))
                                }, onKeyDown: function (e) {
                                    if (e.key !== "Escape") {
                                        e.stopPropagation();
                                    }
                                }, onChange: function (e) { return setSearchText(e.target.value); } }), displayedOptions.map(function (dataObj) { return (jsx(SelectMenuItem, __assign({ value: dataObj, style: getStyles(dataObj, Option, theme) }, { children: dataObj }), dataObj)); })] })) })), hasHelperText && jsx(HelperLabel, __assign({ sx: { color: color } }, { children: helperText }))] }));
};

var tabJsxElement = function (word) {
    return jsx(Typography, __assign({ sx: { fontFamily: "Inter" } }, { children: word }));
};
var tabImageJSX = function () {
    return jsx(PhoneMissedIcon, {});
};
/**
 * Primary UI component for user interaction
 */
var KpTabs = function (_a) {
    ...
    var _b = React.useState(props.currentTab || "1"), value = _b[0], setValue = _b[1];
    var handleChange = function (event, newValue) {
        setValue(newValue);
    };
    var TabComponent = styled$1(Tab)({
        fontSize: "14px",
        fontFamily: "Inter",
        height: "21px",
        padding: "0 7.5px",
    ...
    return (jsx(Fragment, { children: jsx(Box$1, __assign({ sx: { width: "100%", typography: "body1" } }, { children: jsxs(TabContext, __assign({ value: value }, { children: [jsx(Box$1, __assign({ sx: { borderBottom: 1, borderColor: "divider" } }, { children: jsx(TabList, __assign({ TabIndicatorProps: {
                                style: {
                                    backgroundColor: "#151D44",
                                },
                            }, onChange: handleChange, "aria-label": "lab API tabs example" }, { children: data &&
                                data.map(function (item) { return (jsx(TabComponent, { disabled: item.disabled, label: item.tabLable, value: item.tabCode, icon: (item === null || item === void 0 ? void 0 : item.icons) ? item === null || item === void 0 ? void 0 : item.icons : "", iconPosition: (item === null || item === void 0 ? void 0 : item.iconPosition) ? item === null || item === void 0 ? void 0 : item.iconPosition : "end" }, item.tabCode)); }) })) })), data &&
                        data.map(function (item) { return (jsx(TabPanel, __assign({ value: item.tabCode }, { children: item.tabContent }), item.tabCode)); })] })) })) }));
};
...
var KpBadge = function (_a) {
    ...
    var BadgeComponent = styled$1(Badge)({
        "& .MuiBadge-badge": {
            background: color,
            color: '#ffff',
            fontFamily: "Inter"
    ...
    return (jsx(Fragment, { children: jsx(BadgeComponent, __assign({ variant: type, anchorOrigin: {
                vertical: vertical,
...
var sampleInnerTooltipComponent = function () {
    return (jsx(Button$1, __assign({ style: { margin: '60px 200px', fontFamily: "Inter" } }, { children: 'Sample Inner Component' })));
};
var KpTooltip = function (_a) {
    ...
    return (jsx(Fragment, { children: jsx(Tooltip, __assign({ title: content, placement: position, arrow: true, PopperProps: {
                sx: {
                    "& .MuiTooltip-tooltip": {
                        background: '#1E2332',
                        borderRadius: '3px',
...
function KpSidebarMenu(_a) {
    ...
    var _c = useState(open), isSideBarOpen = _c[0]; _c[1];
    ...
    return (jsx(Box, __assign({ sx: { height: "100%" } }, { children: jsx(List, __assign({ component: "nav", "aria-labelledby": "nested-list-subheader" }, { children: isSideBarOpen &&
                (menu === null || menu === void 0 ? void 0 : menu.map(function (menuItem, index) {
                    return (jsxs(ListItemButton, __assign({ sx: {
                            ...
                            marginLeft: "10px",
                            marginBottom: "6px",
                        }, onClick: function () { return onMenuItemClick(menuItem); } }, { children: [menuItem.icon && (jsx(ListItemIcon, __assign({ sx: {
                                    minWidth: "40px",
                                    opacity: menuItem.isGroupItem &&
                                        ...
                                        ? "0.2"
                                        : "1",
                                } }, { children: menuItem.icon }))), menuItem.isGroupItem && (jsx(Box, __assign({ sx: {
                                    marginRight: "1rem",
                                    width: "25px",
                                    height: "25px",
                                    borderRadius: "50%",
                                    ...
                                    opacity: menuItem.isGroupItem &&
                                        ...
                                        ? "0.2"
                                        : "1",
                                } }, { children: index }))), jsx(ListItemText, { primaryTypographyProps: {
                                    ...
                                    opacity: menuItem.isGroupItem &&
                                        ...
                                        ? "0.2"
                                        : "1",
                                }, primary: menuItem.title }), menuItem.isParent && !menuItem.isBackAllow && (jsx(ListItemIcon, __assign({ sx: { marginLeft: "6rem" } }, { children: jsx(ArrowForwardIcon, {}) })))] }), menuItem.id));
                })) })) })));
}
...
var KpSidebar = function (_a) {
    ...
    var _e = useState(false), openSubItem = _e[0], setOpenSubItem = _e[1];
    var _f = useState(null), subItemIndex = _f[0], setSubItemIndex = _f[1];
    var _g = useState([]), openedSubItems = _g[0], setOpenedSubItems = _g[1];
    var _h = useState(0), selectedGroup = _h[0], setSelectedGroup = _h[1];
    ...
    var subItems = function (sublistItems, index) {
        ...
        return (jsx(Fragment, { children: getRenderConditions() && (jsx(Box, __assign({ component: "div", style: __assign({}, subMenuStyle()), className: !open && hideText ? "hide-SubMenu-list" : "" }, { children: jsx(List, { children: sublistItems &&
                        sublistItems.map(function (listItem, index) {
                            return (jsxs(Fragment, { children: [createElement(ListItem, __assign({ sx: { paddingTop: "0px" } }, props, { key: index }), listItem.url ? (jsx(ListItemButton, __assign({ to: listItem.url, component: Link, sx: (location.pathname === listItem.url &&
                                            ...
                                            return handleListItemClick(event, listItem);
                                        }, className: !open && hideText ? "hide-SideMenu-text" : "" }, { children: listItem && listItem.listIcon && (jsx(Fragment, { children: jsx(ListItemText, { sx: {
                                                    ...
                                                    ? "hide-SideMenu-text"
                                                    : "" }) })) }))) : (jsxs(Fragment, { children: [listItem && listItem.listIcon && (jsx("span", { children: listItem.listIcon })), listItem && (jsx("span", __assign({ className: !open && hideText ? "hide-SideMenu-text" : "" }, { children: listItem.listText.length !== 0
                                                    ? listItem.listText
                                                    : "Item Name" })))] }))), listItem.group && (jsxs(Box, __assign({ sx: {
                                            ...
                                            borderRadius: "6px",
                                            userSelect: "none",
                                        } }, { children: [jsx(Box, __assign({ sx: { textAlign: "center", margin: "16px 0px" } }, { children: listItem.group.groupName.length !== 0
                                                ...
                                                return (jsxs(Box, __assign({ sx: {
                                                        ...
                                                        marginLeft: "32px",
                                                                ...
                                                                ? "hide-SideMenu-text"
                                                                : "" }, { children: groupItem.id })), jsx(Box, __assign({ sx: { marginTop: "2px" } }, { children: groupItem.content }))] }), index));
                                            })] })))] }));
                        }) }) }))) }));
    };
    ...
    var SideBarComponent = styled$3(Box)({
        flex: 1,
        backgroundColor: backGroundColor ? backGroundColor : "#F4F4F6",
    ...
    var sideList = function () { return (jsxs(Fragment, { children: [!open ? (jsx(IconButton, __assign({ onClick: toggleSlider, style: {
                    background: "transparent",
                    position: "absolute",
                    right: "-27px",
                    top: "15px",
                } }, { children: jsx(Icon, { color: "#fff", iconName: "SVG-chevronRight", iconSize: 2, side: "left", type: IconType.SVG }) }))) : (jsx(IconButton, __assign({ onClick: toggleSlider, style: {
                    background: "transparent",
                    position: "absolute",
                    right: "-27px",
                    top: "15px",
                } }, { children: jsx(Icon, { color: "#fff", iconName: "SVG-chevronLeft", iconSize: 2, side: "left", type: IconType.SVG }) }))), jsxs(SideBarComponent, __assign({ component: "div", className: hideText ? "setMargin-top" : "" }, { children: [title && !hideText && (jsx("h3", __assign({ style: {
                            color: "#666C7F",
                            padding: "10px 16px",
                            fontSize: "16px",
                            letterSpacing: "0.15px",
                        } }, { children: !open && hideText ? "" : title }))), !isMenuSideBar ? (jsx(List, { children: listItems &&
                            listItems.map(function (listItem, index) { return (jsxs(Fragment, { children: [createElement(ListItem, __assign({}, props, { key: index, onClick: function () { return onSubitemClick(index); }, sx: { padding: "0px", margin: "8px 0px" } }), listItem.url ? (jsxs(ListItemButton, __assign({ to: listItem.url, component: Link, onClick: function (event) {
                                            return handleListItemClick(event, listItem);
                                            ...
                                            : {
                                                ...
                                                height: "40px",
                                            }, className: !open && hideText ? "hide-SideMenu-text" : "" }, { children: [listItem && (jsxs(Box, __assign({ sx: { display: "flex", alignItems: "center" } }, { children: [(listItem === null || listItem === void 0 ? void 0 : listItem.listIcon) && (jsx(ListItemIcon, __assign({ sx: { minWidth: "0px" } }, { children: jsxs("span", __assign({ className: "icon-wrapper ".concat(!open && hideText && onHoverText
                                                                ? "sideMenu-hover"
                                                                : "") }, { children: [listItem.listIcon, !open && hideText && onHoverText && (jsx("span", __assign({ className: "menuHover-Text" }, { children: listItem.listText.length !== 0
                                                                        ? listItem.listText
                                                                        : "Item Name" })))] })) }))), jsx(ListItemText, { primary: listItem.listText.length !== 0
                                                            ? listItem.listText
                                                            : "Item Name", primaryTypographyProps: listItemTextStyle((location.pathname === listItem.url &&
                                                            listItem.id === selectedItem) ||
                                                            !!listItem.active), className: !open && hideText ? "hide-text" : "" })] }))), listItem && listItem.subItems && (jsx("span", __assign({ style: {
                                                    position: "absolute",
                                                    right: "0",
                                                    top: "10px",
                                                } }, { children: jsx(Icon, { color: listItem.active ? "#1E2332" : "#666C7F", iconName: getRenderConditionsForArrowIcons(index)
                                                        ? ICONS.ARROWTOP
                                                        : ICONS.ARROWDOWN, iconSize: 1.5, side: "left", type: IconType.MUI }) })))] }))) : (jsxs(Box, __assign({ sx: {
                                            padding: "8px 16px",
                                            display: "flex",
                                            alignItems: "center",
                                        } }, { children: [listItem && listItem.listIcon && (jsx(Fragment, { children: jsxs("span", __assign({ className: !open && hideText && onHoverText
                                                        ? "sideMenu-hover"
                                                        : "" }, { children: [listItem.listIcon, !open && hideText && onHoverText && (jsx("span", __assign({ className: "menuHover-Text" }, { children: listItem.listText.length !== 0
                                                                ? listItem.listText
                                                                : "Item Name" })))] })) })), listItem && (jsx("span", __assign({ style: {
                                                    ...
                                                    ? listItem.listText
                                                    : "Item Name" }))), listItem && listItem.subItems && (jsx("span", __assign({ style: { position: "absolute", right: "0" }, className: !open && hideText ? "hide-SideMenu-text" : "" }, { children: jsx(Icon, { color: listItem.active ? "#1E2332" : "#666C7F", iconName: getRenderConditionsForArrowIcons(index)
                                                        ? ICONS.ARROWTOP
                                                        : ICONS.ARROWDOWN, iconSize: 1.5, side: "left", type: IconType.MUI }) })))] })))), listItem &&
                                        listItem.subItems &&
                                        subItems(listItem.subItems, index), listItem.group && (jsxs(Box, __assign({ sx: {
                                            display: listItem.group.id === selectedGroup
                                                ? "block"
                                                : "none",
                                            backgroundColor: "white",
                                            ...
                                            borderRadius: "6px",
                                            userSelect: "none",
                                        } }, { children: [jsx(Box, __assign({ sx: { margin: "16px 0px", marginLeft: "32px" } }, { children: listItem.group.groupName.length !== 0
                                                    ? listItem.group.groupName
                                                    : "Group Name" })), listItem.group.groupItems.map(function (groupItem, index) {
                                                var _a;
                                                return (jsxs(Box, __assign({ sx: {
                                                        ...
                                                        marginLeft: "32px",
                                                                ...
                                                                fontSize: "14px",
                                                                fontWeight: "700",
                                                            } }, { children: groupItem.id })), jsx(Box, __assign({ sx: { marginTop: "2px", fontWeight: "700" } }, { children: groupItem.content }))] }), index));
                                            })] })))] })); }) })) : (jsx(KpSidebarMenu, { currentRoute: currentRoute, open: open, onRouteChange: function (path, setMenu) {
                            onMenuRouteChange && onMenuRouteChange(path, setMenu);
                        } }))] })), jsx("div", __assign({ style: __assign({}, footerCss()) }, { children: footer && footer }))] })); };
    return (jsx(Drawer, __assign({ variant: "permanent", open: open, anchor: "left", onClose: toggleSlider, sx: {
            backgroundColor: backGroundColor ? backGroundColor : "#F4F4F6",
            "& .MuiDrawer-root": {
                position: "absolute",
            },
        ...
        }, className: "custom-sidebar" }, { children: jsx(Fragment, { children: sideList() }) })));
};
...
var KpLabel = function (_a) {
    var _b = _a.variant, variant = _b === void 0 ? VARIANTS.DEFAULT : _b, _c = _a.status, status = _c === void 0 ? STATUS.PRIMARY : _c, content = _a.content, hasIconStatus = _a.hasIconStatus, icon = _a.icon, leftIconType = _a.leftIconType, iconColor = _a.iconColor, props = __rest$1(_a, ["variant", "status", "content", "hasIconStatus", "icon", "leftIconType", "iconColor"]);
    var checkVariant = function (type) {
    ...
    var BoxComponent = styled$1(Button)(__assign({ display: 'inline-flex', alignItems: 'flex-start', m: 1, p: 1, fontSize: '12px', "&:hover": {
    ...
    return (jsx(Fragment, { children: jsx(BoxComponent, __assign({ disableRipple: true, variant: checkVariant(variant) }, { children: jsxs(Fragment, { children: [jsxs(Fragment, { children: [" ", hasIconStatus ?
                                jsx(Icon, __assign({ iconName: icon, side: 'left', type: leftIconType, color: iconColor, iconSize: 0.9 }, props))
                                : null] }), content] }) })) }));
};

var TitleLabel = styled$3(InputLabel)({
    fontSize: "32px",
    fontWeight: 500,
    lineHeight: "38.19px",
    color: "#1E2332",
...
var DismissOverview = styled$3(InputLabel)({
    color: "#253378",
    fontSize: "14px",
    fontWeight: 400,
    lineHeight: "21px",
...
var ContentData = styled$3(Typography$1)({
    display: "flex",
    fontSize: "16px",
    color: "#1E2332",
    lineHeight: "21px",
...
var TextControllerExpand = styled$3(InputLabel)({
    color: "#253378",
    fontSize: "14px",
    fontWeight: 400,
    lineHeight: "21px",
...
var TextControllerCollapse = styled$3(InputLabel)({
    color: "#253378",
    fontSize: "14px",
    fontWeight: 400,
    lineHeight: "21px",
...
var NavWrapper = styled$3('div')({
    display: 'table',
    cursor: 'pointer',
});
var NavIcon = styled$3(Icon)({
    color: "#243173",
    display: "table-cell",
    verticalAlign: "middle"
});
var NavText = styled$3(Typography$1)({
    color: "#243173",
    fontSize: '14px',
    fontWeight: 700,
    lineHeight: '21px',
...
var KpOverview = function (_a) {
    ...
    var _c = useState(false), isExpanded = _c[0], setExpand = _c[1];
    var _d = useState(false), dismiss = _d[0], setDismiss = _d[1];
    var onBtnClick = function () {
        if (typeof onNavPress !== 'undefined') {
            onNavPress();
        }
    };
    return (jsxs(Fragment, { children: [withNavigation &&
                jsxs(NavWrapper, __assign({ onClick: onBtnClick }, { children: [jsx(NavIcon, { iconName: navigationIcon, type: iconType, color: "#243173" }), jsx(NavText, { children: navigationText })] })), jsxs(Stack, __assign({ direction: "row", spacing: 4, mt: 1, mr: 3, sx: { alignItems: "center" } }, { children: [jsx(TitleLabel, { children: title }), showActionButton &&
                        jsx(NavText, __assign({ sx: { cursor: 'pointer', textTransform: "uppercase", alignItems: "right" }, onClick: function (e) { return onActionBtnClick === null || onActionBtnClick === void 0 ? void 0 : onActionBtnClick(title); } }, { children: actionBtnText }))] })), !dismiss && (jsx(Fragment, { children: content.length > contentLength ? (jsx(Fragment, { children: !isExpanded ? (jsxs(Fragment, { children: [jsx(ContentData, { children: content.slice(0, contentLength) }), jsx(TextControllerExpand, __assign({ onClick: function () { return setExpand(true); } }, { children: "Expand content" }))] })) : (jsxs(Fragment, { children: [jsx(ContentData, { children: content }), jsx(TextControllerCollapse, __assign({ onClick: function () { return setExpand(false); } }, { children: "Collapse content" }))] })) })) : (jsx(Fragment, { children: jsx(ContentData, { children: content }) })) })), !dismiss && contentDismissible !== "" && (jsx(DismissOverview, __assign({ onClick: function () { return setDismiss(true); } }, { children: contentDismissible })))] }));
};
...
var KpLogo = function (_a) {
    ...
    var blueLogo = function () {
        return (jsxs("svg", __assign({ width: width, height: height, viewBox: "0 0 1165 345", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, { children: [jsx("mask", __assign({ id: "mask0_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "145", y: "83", width: "182", height: "182" }, { children: jsx("path", { d: "M236.11 115.212C268.491 115.212 290.439 139.521 290.439 173.998C290.439 208.044 268.491 232.784 236.11 232.784C204.067 232.784 181.758 208.838 181.758 173.998C181.758 139.884 204.067 115.212 236.11 115.212ZM236.11 264.719C288.997 264.719 326.786 225.884 326.786 173.93C326.786 121.726 288.997 83.1405 236.47 83.1405C183.561 83.1405 145.411 121.976 145.411 174.225C145.411 226.247 183.561 264.719 236.11 264.719Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask0_1111_8855)" }, { children: jsx("path", { d: "M329.039 81.0069H143.158V266.989H329.039V81.0069Z", fill: "#151D44" }) })), jsx("mask", __assign({ id: "mask1_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "349", y: "83", width: "171", height: "260" }, { children: jsx("path", { d: "M384.743 173.998C384.743 139.952 404.528 114.486 439.072 114.486C455.364 114.122 471.356 118.943 484.771 128.263V215.353C470.755 228.789 454.553 233.511 437.63 233.511C404.888 233.511 384.743 209.565 384.743 173.998ZM437.269 342.73C486.844 342.73 519.698 315.879 519.698 265.083V110.128C495.226 92.3556 469.673 83.2766 438.351 83.2766C384.743 83.2766 349.477 122.475 349.477 174.066C349.477 228.54 381.859 264.856 431.884 264.856C451.906 265.306 471.386 258.281 486.573 245.132C486.213 251.668 485.852 258.932 485.852 265.832C485.852 294.862 468.231 311.544 436.909 311.544C417.845 311.544 395.537 305.37 376.067 294.135L362.389 322.802C384.022 334.378 411.017 342.73 437.269 342.73Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask1_1111_8855)" }, { children: jsx("path", { d: "M521.952 81.0069H347.224V345H521.952V81.0069Z", fill: "#151D44" }) })), jsx("mask", __assign({ id: "mask2_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "550", y: "83", width: "149", height: "177" }, { children: jsx("path", { d: "M550.209 259.272H585.114V163.421C585.114 133.665 604.2 114.44 629.032 114.44C650.259 114.44 663.577 127.128 663.577 151.46V259.227H698.549V144.968C698.549 106.133 674.799 83.2766 639.173 83.2766C616.504 83.2766 597.417 91.9924 583.739 108.675L582.658 88.724H550.209V259.272Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask2_1111_8855)" }, { children: jsx("path", { d: "M700.735 81.0069H547.956V261.542H700.735V81.0069Z", fill: "#151D44" }) })), jsx("mask", __assign({ id: "mask3_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "731", y: "88", width: "36", height: "172" }, { children: jsx("path", { d: "M766.083 88.724H731.178V259.272H766.083V88.724Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask3_1111_8855)" }, { children: jsx("path", { d: "M768.337 86.4543H728.925V261.542H768.337V86.4543Z", fill: "#151D44" }) })), jsx("mask", __assign({ id: "mask4_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "794", y: "37", width: "91", height: "226" }, { children: jsx("path", { d: "M859.644 262.54C867.923 262.403 876.149 261.182 884.116 258.909L881.254 228.789C877.137 229.874 872.911 230.483 868.657 230.605C855.7 230.605 850.292 222.979 850.292 194.289V117.754H879.812V88.724H850.292V37.1783H815.387V88.724H794.16V117.754H815.387V197.581C815.387 243.656 829.786 262.54 859.644 262.54Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask4_1111_8855)" }, { children: jsx("path", { d: "M886.391 34.9086H791.907V264.788H886.391V34.9086Z", fill: "#151D44" }) })), jsx("mask", __assign({ id: "mask5_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "914", y: "88", width: "36", height: "172" }, { children: jsx("path", { d: "M949.261 88.724H914.356V259.272H949.261V88.724Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask5_1111_8855)" }, { children: jsx("path", { d: "M951.514 86.4543H912.103V261.542H951.514V86.4543Z", fill: "#151D44" }) })), jsx("mask", __assign({ id: "mask6_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "974", y: "88", width: "172", height: "172" }, { children: jsx("path", { d: "M1047.82 259.272H1072.3L1145.4 92.3556V88.724H1110.49L1080.61 162.014C1073.42 179.809 1065.85 200.123 1060.83 213.537C1056.14 200.123 1048.59 179.809 1041.38 162.014L1011.16 88.724H974.814V92.3556L1047.82 259.272Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask6_1111_8855)" }, { children: jsx("path", { d: "M1147.65 86.4543H972.561V261.542H1147.65V86.4543Z", fill: "#151D44" }) })), jsx("mask", __assign({ id: "mask7_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "1121", y: "222", width: "42", height: "40" }, { children: jsx("path", { d: "M1142.31 261.973C1154.18 261.973 1162.75 253.802 1162.75 242.34C1162.75 230.878 1154.18 222.707 1142.31 222.707C1130.43 222.707 1121.53 230.878 1121.53 242.34C1121.53 253.802 1130.1 261.973 1142.31 261.973Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask7_1111_8855)" }, { children: jsx("path", { d: "M1165 220.437H1119.28V264.265H1165V220.437Z", fill: "#22DBD1" }) })), jsx("mask", __assign({ id: "mask8_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "726", y: "17", width: "43", height: "40" }, { children: jsx("path", { d: "M747.718 56.7434C759.594 56.7434 768.156 48.5497 768.156 37.0875C768.156 25.6253 759.594 17.4543 747.718 17.4543C735.505 17.4543 726.942 25.648 726.942 37.0875C726.942 48.527 735.505 56.7434 747.718 56.7434Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask8_1111_8855)" }, { children: jsx("path", { d: "M770.41 15.2753H724.689V59.104H770.41V15.2753Z", fill: "#151D44" }) })), jsx("mask", __assign({ id: "mask9_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "911", y: "17", width: "42", height: "40" }, { children: jsx("path", { d: "M931.887 56.7434C943.763 56.7434 952.348 48.5497 952.348 37.0875C952.348 25.6253 943.763 17.4543 931.887 17.4543C920.012 17.4543 911.134 25.648 911.134 37.0875C911.134 48.527 919.697 56.7434 931.887 56.7434Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask9_1111_8855)" }, { children: jsx("path", { d: "M954.601 15.2753H908.88V59.104H954.601V15.2753Z", fill: "#151D44" }) })), jsx("mask", __assign({ id: "mask10_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "2", y: "2", width: "38", height: "258" }, { children: jsx("path", { d: "M39.1187 2.26973H2.25336V259.794H39.1187V2.26973Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask10_1111_8855)" }, { children: jsx("path", { d: "M41.3721 0H0V262.064H41.3721V0Z", fill: "#151D44" }) })), jsx("mask", __assign({ id: "mask11_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "21", y: "87", width: "129", height: "175" }, { children: jsx("path", { d: "M21.7677 174.679L101.538 261.973H149.76L70.8464 174.679L147.259 87.3849L98.9461 87.748L21.7677 174.679Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask11_1111_8855)" }, { children: jsx("path", { d: "M151.991 85.1151H19.5143V264.243H151.991V85.1151Z", fill: "#22DBD1" }) }))] })));
    };
    var whiteLogo = function () {
        return (jsxs("svg", __assign({ width: width, height: height, viewBox: "0 0 1165 345", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, { children: [jsx("mask", __assign({ id: "mask0_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "145", y: "83", width: "182", height: "182" }, { children: jsx("path", { d: "M236.11 115.212C268.491 115.212 290.439 139.521 290.439 173.998C290.439 208.044 268.491 232.784 236.11 232.784C204.067 232.784 181.758 208.838 181.758 173.998C181.758 139.884 204.067 115.212 236.11 115.212ZM236.11 264.719C288.997 264.719 326.786 225.884 326.786 173.93C326.786 121.726 288.997 83.1405 236.47 83.1405C183.561 83.1405 145.411 121.976 145.411 174.225C145.411 226.247 183.561 264.719 236.11 264.719Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask0_1111_8855)" }, { children: jsx("path", { d: "M329.039 81.0069H143.158V266.989H329.039V81.0069Z", fill: "white" }) })), jsx("mask", __assign({ id: "mask1_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "349", y: "83", width: "171", height: "260" }, { children: jsx("path", { d: "M384.743 173.998C384.743 139.952 404.528 114.486 439.072 114.486C455.364 114.122 471.356 118.943 484.771 128.263V215.353C470.755 228.789 454.553 233.511 437.63 233.511C404.888 233.511 384.743 209.565 384.743 173.998ZM437.269 342.73C486.844 342.73 519.698 315.879 519.698 265.083V110.128C495.226 92.3556 469.673 83.2766 438.351 83.2766C384.743 83.2766 349.477 122.475 349.477 174.066C349.477 228.54 381.859 264.856 431.884 264.856C451.906 265.306 471.386 258.281 486.573 245.132C486.213 251.668 485.852 258.932 485.852 265.832C485.852 294.862 468.231 311.544 436.909 311.544C417.845 311.544 395.537 305.37 376.067 294.135L362.389 322.802C384.022 334.378 411.017 342.73 437.269 342.73Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask1_1111_8855)" }, { children: jsx("path", { d: "M521.952 81.0069H347.224V345H521.952V81.0069Z", fill: "white" }) })), jsx("mask", __assign({ id: "mask2_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "550", y: "83", width: "149", height: "177" }, { children: jsx("path", { d: "M550.209 259.272H585.114V163.421C585.114 133.665 604.2 114.44 629.032 114.44C650.259 114.44 663.577 127.128 663.577 151.46V259.227H698.549V144.968C698.549 106.133 674.799 83.2766 639.173 83.2766C616.504 83.2766 597.417 91.9924 583.739 108.675L582.658 88.724H550.209V259.272Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask2_1111_8855)" }, { children: jsx("path", { d: "M700.735 81.0069H547.956V261.542H700.735V81.0069Z", fill: "white" }) })), jsx("mask", __assign({ id: "mask3_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "731", y: "88", width: "36", height: "172" }, { children: jsx("path", { d: "M766.083 88.724H731.178V259.272H766.083V88.724Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask3_1111_8855)" }, { children: jsx("path", { d: "M768.337 86.4543H728.925V261.542H768.337V86.4543Z", fill: "white" }) })), jsx("mask", __assign({ id: "mask4_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "794", y: "37", width: "91", height: "226" }, { children: jsx("path", { d: "M859.644 262.54C867.923 262.403 876.149 261.182 884.116 258.909L881.254 228.789C877.137 229.874 872.911 230.483 868.657 230.605C855.7 230.605 850.292 222.979 850.292 194.289V117.754H879.812V88.724H850.292V37.1783H815.387V88.724H794.16V117.754H815.387V197.581C815.387 243.656 829.786 262.54 859.644 262.54Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask4_1111_8855)" }, { children: jsx("path", { d: "M886.391 34.9086H791.907V264.788H886.391V34.9086Z", fill: "white" }) })), jsx("mask", __assign({ id: "mask5_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "914", y: "88", width: "36", height: "172" }, { children: jsx("path", { d: "M949.261 88.724H914.356V259.272H949.261V88.724Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask5_1111_8855)" }, { children: jsx("path", { d: "M951.514 86.4543H912.103V261.542H951.514V86.4543Z", fill: "white" }) })), jsx("mask", __assign({ id: "mask6_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "974", y: "88", width: "172", height: "172" }, { children: jsx("path", { d: "M1047.82 259.272H1072.3L1145.4 92.3556V88.724H1110.49L1080.61 162.014C1073.42 179.809 1065.85 200.123 1060.83 213.537C1056.14 200.123 1048.59 179.809 1041.38 162.014L1011.16 88.724H974.814V92.3556L1047.82 259.272Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask6_1111_8855)" }, { children: jsx("path", { d: "M1147.65 86.4543H972.561V261.542H1147.65V86.4543Z", fill: "white" }) })), jsx("mask", __assign({ id: "mask7_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "1121", y: "222", width: "42", height: "40" }, { children: jsx("path", { d: "M1142.31 261.973C1154.18 261.973 1162.75 253.802 1162.75 242.34C1162.75 230.878 1154.18 222.707 1142.31 222.707C1130.43 222.707 1121.53 230.878 1121.53 242.34C1121.53 253.802 1130.1 261.973 1142.31 261.973Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask7_1111_8855)" }, { children: jsx("path", { d: "M1165 220.437H1119.28V264.265H1165V220.437Z", fill: "#22DBD1" }) })), jsx("mask", __assign({ id: "mask8_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "726", y: "17", width: "43", height: "40" }, { children: jsx("path", { d: "M747.718 56.7434C759.594 56.7434 768.156 48.5497 768.156 37.0875C768.156 25.6253 759.594 17.4543 747.718 17.4543C735.505 17.4543 726.942 25.648 726.942 37.0875C726.942 48.527 735.505 56.7434 747.718 56.7434Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask8_1111_8855)" }, { children: jsx("path", { d: "M770.41 15.2753H724.689V59.104H770.41V15.2753Z", fill: "white" }) })), jsx("mask", __assign({ id: "mask9_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "911", y: "17", width: "42", height: "40" }, { children: jsx("path", { d: "M931.887 56.7434C943.763 56.7434 952.348 48.5497 952.348 37.0875C952.348 25.6253 943.763 17.4543 931.887 17.4543C920.012 17.4543 911.134 25.648 911.134 37.0875C911.134 48.527 919.697 56.7434 931.887 56.7434Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask9_1111_8855)" }, { children: jsx("path", { d: "M954.601 15.2753H908.88V59.104H954.601V15.2753Z", fill: "white" }) })), jsx("mask", __assign({ id: "mask10_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "2", y: "2", width: "38", height: "258" }, { children: jsx("path", { d: "M39.1187 2.26973H2.25336V259.794H39.1187V2.26973Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask10_1111_8855)" }, { children: jsx("path", { d: "M41.3721 0H0V262.064H41.3721V0Z", fill: "white" }) })), jsx("mask", __assign({ id: "mask11_1111_8855", style: { maskType: 'luminance' }, maskUnits: "userSpaceOnUse", x: "21", y: "87", width: "129", height: "175" }, { children: jsx("path", { d: "M21.7677 174.679L101.538 261.973H149.76L70.8464 174.679L147.259 87.3849L98.9461 87.748L21.7677 174.679Z", fill: "white" }) })), jsx("g", __assign({ mask: "url(#mask11_1111_8855)" }, { children: jsx("path", { d: "M151.991 85.1151H19.5143V264.243H151.991V85.1151Z", fill: "#22DBD1" }) }))] })));
    };
    return (jsx("div", __assign({ style: logoStyles }, { children: color && color == 'Blue' ? blueLogo() : whiteLogo() })));
};

var HeaderWrapper = styled$3('div')({
    width: '100%',
    height: '64px',
    display: 'flex',
    flexDirection: 'row',
...
var LeftWrapper = styled$3('div')({
    display: 'flex',
    alignItems: 'center',
    height: '100%'
});
var ProductWrapper = styled$3('div')({
    display: "flex",
    flexDirection: 'row',
    height: '100%',
    alignItems: 'center',
});
var LogoWrapper = styled$3('div')({
    height: '28px',
    width: '95.24px',
});
styled$3(Typography$1)({
    fontSize: '16px',
    fontWeight: 700,
    lineHeight: '19.36px',
    fontFamily: "Inter",
...
var PlatformTextButton = styled$3(IconButton)({
    fontSize: '16px',
    fontWeight: 700,
    lineHeight: '19.36px',
    fontFamily: "Inter",
...
var SwitcherWrapper = styled$3('div')({
    width: '185px',
    display: 'flex',
    flexDirection: 'row',
    marginLeft: '8px',
...
var TabWrapper = styled$3('div')({
    display: 'flex',
    marginLeft: '24px'
});
var TabButton = styled$3(Tab$1)({
    display: 'block',
    fontSize: '14px',
    lineHeight: '21px',
    color: '#151D44',
...
var ClientText = styled$3(Typography$1)({
    color: '#9BA0AF',
    fontSize: '14px',
    fontFamily: "Inter"
});
var Line1 = styled$3(Divider)({
    marginTop: '8px',
    marginBottom: '8px',
    marginLeft: '24px',
    marginRight: '24px',
...
var Line2 = styled$3(Divider)({
    marginTop: '8px',
    marginBottom: '8px',
    marginRight: '24px',
    borderColor: '#E0E1E6'
});
var IconWrapper = styled$3('div')({
    display: 'flex',
    flexDirection: 'row'
});
var IconBtn = styled$3(IconButton)({
    width: '24px',
    height: '24px',
    marginRight: '24px'
});
var UserWrapper = styled$3('div')({
    display: 'flex',
    flexDirection: 'row',
    alignItems: 'center'
});
var UserDetailsWrapper = styled$3('div')({
    display: 'flex',
    flexDirection: 'column',
    marginLeft: '8px'
});
var UserAvatar = styled$3(Avatar)({
    width: '40px',
    height: '40px'
});
var UserName = styled$3(Typography$1)({
    fontSize: '14px',
    fontWeight: 400,
    lineHeight: '21px',
    color: '#1E2332',
...
var UserRole = styled$3(Typography$1)({
    fontSize: '12px',
    fontWeight: 400,
    lineHeight: '18px',
    color: '#9BA0AF',
...
var IconBtnDropDown = styled$3(IconButton)({
    width: '24px',
    height: '24px',
    marginLeft: '14px',
});
var ContentHolder = styled$3('div')({
    display: 'flex',
    position: 'absolute',
    backgroundColor: '#ffffff',
    zIndex: 1500,
...
var TestJSXElementOne = function () {
    return (jsxs(Box, __assign({ sx: { width: '200px', display: 'flex', flexDirection: 'column' } }, { children: [jsx(Typography$1, __assign({ sx: { fontFamily: "Inter" } }, { children: "Access Manger" })), jsx(Typography$1, __assign({ sx: { fontFamily: "Inter" } }, { children: "Pulse" }))] })));
};
var TestJSXElementTwo = function () {
    return (jsxs(Box, __assign({ sx: { display: 'flex', width: '200px', flexDirection: 'column' } }, { children: [jsx(Typography$1, __assign({ sx: { fontFamily: "Inter" } }, { children: "Change Tenant..." })), jsx(Typography$1, __assign({ sx: { fontFamily: "Inter" } }, { children: "Logout" }))] })));
};
var DropDownMenu = function (_a) {
    ...
    var _b = useState(triggerOpen), isOpen = _b[0], setOpen = _b[1];
    ...
    return (jsx(Fragment, { children: jsxs(IconBtnDropDown, __assign({ disableRipple: true, onClick: toggleBtn }, { children: [jsx(Icon, { iconName: isOpen ? dropDownCloseIcon : dropDownOpenIcon, iconSize: dropDownIconSize, color: iconColor, type: iconType }), isOpen &&
                    jsx(ContentHolder, __assign({ ref: contentHolderRef }, props, { children: content }))] })) }));
};
var KpHeader = function (_a) {
    ...
    var _b = useState(tabs.length > 0 ? tabs[0].id : null), value = _b[0], setValue = _b[1];
    var _c = useState(tabs.length && tabs[0].status), tabStatus = _c[0], setTabStatus = _c[1];
    var _d = useState(false), userOpsExpanded = _d[0], setUserOpsExpanded = _d[1];
    var _e = useState(false), platFormExpanded = _e[0], setPlatFormExpanded = _e[1];
    ...
    return (jsx(Fragment, { children: jsxs(HeaderWrapper, { children: [jsxs(LeftWrapper, { children: [jsxs(ProductWrapper, __assign({ style: { width: !dropdownMenuDisabled ? '320.24px' : '82.8px' } }, { children: [jsx(LogoWrapper, { children: jsx(KpLogo, { color: "Blue", width: 94.24, height: 28 }) }), !dropdownMenuDisabled && (jsxs(SwitcherWrapper, { children: [jsx(PlatformTextButton, __assign({ disableRipple: true, onClick: function () { setPlatFormExpanded(!platFormExpanded); } }, { children: productName.length > 15 ? "".concat(productName.slice(0, 14), "...") : productName })), jsx(DropDownMenu, __assign({ dropDownOpenIcon: dropDownOpenIcon, dropDownCloseIcon: dropDownCloseIcon, dropDownIconSize: dropDownIconSize, iconColor: iconColor, iconType: iconType, content: platformSwitcherContent }, props, { triggerOpen: platFormExpanded }))] }))] })), jsx(TabWrapper, { children: jsx(Tabs, __assign({ value: value, onChange: onTabChange, sx: { color: '#151D44', height: '55px', paddingTop: '10px', fontFamily: "Inter" }, TabIndicatorProps: {
                                    style: {
                                        backgroundColor: "#151D44",
                                        color: '#151D44',
                                    ...
                                    return (jsx(TabButton, { disableRipple: true, value: id, label: label, sx: { color: '#151D44', fontFamily: "Inter", textTransform: 'capitalize', '&.Mui-selected': __assign({}, styleInactive) }, disabled: status === 'Disabled' ? true : false }, id));
                                }) })) })] }), jsxs(RightWrapper, { children: [jsx(ClientText, { children: companyName }), jsx(Line1, { orientation: "vertical", flexItem: true }), isIconListShowing &&
                            jsxs(Fragment, { children: [jsxs(IconWrapper, { children: [helpIconShow && (jsx(IconBtn, __assign({ size: "large", color: "inherit", onClick: onHelpClick }, { children: jsx(KpBadge, { color: "#EA421A", vertical: 'top', horizontal: 'right', innerComponent: jsx(Icon, { iconName: ICONS.HELPCERCLE, type: IconType.MUI, color: "#666C7F" }) }) }))), notificationIconShow && (jsx(IconBtn, __assign({ size: "large", "aria-label": "show 17 new notifications", color: "inherit", onClick: onNotificationClick }, { children: jsx(KpBadge, { color: "#EA421A", vertical: 'top', horizontal: 'right', maxCount: maxCountNotification, value: hasNotification ? notificationCount : undefined, innerComponent: jsx(Icon, { iconName: ICONS.NOTIFICATIONOUTLINE, type: IconType.MUI, color: "#666C7F" }) }) }))), settingsIconShow && (jsx(IconBtn, __assign({ size: "large", color: "inherit", onClick: onSettingsClick }, { children: jsx(KpBadge, { color: "#EA421A", vertical: 'top', horizontal: 'right', innerComponent: jsx(Icon, { iconName: ICONS.SETTINGSICON, type: IconType.MUI, color: "#666C7F" }) }) })))] }), jsx(Line2, { orientation: "vertical", flexItem: true })] }), jsxs(UserWrapper, { children: [jsx(UserAvatar, __assign({ sx: { bgcolor: avatarBgColor ? avatarBgColor : "#".concat(randomColor) }, onClick: function () { setUserOpsExpanded(!userOpsExpanded); } }, { children: userName.slice(0, 1) })), jsxs(UserDetailsWrapper, { children: [jsx(UserName, { children: userName.length > 15 ? "".concat(userName.slice(0, 15), "...") : userName }), jsx(UserRole, { children: userRole.length > 20 ? "".concat(userRole.slice(0, 20), "...") : userRole })] }), jsx(DropDownMenu, __assign({ dropDownOpenIcon: dropDownOpenIcon, dropDownCloseIcon: dropDownCloseIcon, dropDownIconSize: dropDownIconSize, iconColor: iconColor, iconType: iconType, triggerOpen: userOpsExpanded, content: appOptionContent }, props2))] })] })] }) }));
};
...
var ModalTestJSXElementTwo = function () {
    return (jsx("p", { children: "Modal content" }));
};
var ModelTestHeaderElement = function () {
    return (jsx(OutlinedInput, { placeholder: "Input value", sx: { ml: 10 } }));
};
var ModelTestFooterElement = function () {
    return (jsx("p", { children: "Footer content" }));
};
var ModalTestJSXElementOne = function () {
    return (jsxs(Box$1, __assign({ sx: { display: 'flex', flexDirection: 'column' } }, { children: [jsx(Typography, __assign({ variant: "h6" }, { children: "Name your campaign" })), jsx(Typography, __assign({ variant: "body1", gutterBottom: true }, { children: "You can always change this name later on." })), jsxs(Box$1, __assign({ sx: { mt: 3 } }, { children: [jsx(Typography, __assign({ variant: "caption", display: "block", gutterBottom: true }, { children: "Name" })), jsx(OutlinedInput, { placeholder: "New customer engagement", fullWidth: true })] })), jsxs(Stack, __assign({ direction: "row", spacing: 2, sx: { mt: 2 } }, { children: [jsxs("div", { children: [jsx(Typography, __assign({ variant: "subtitle2", gutterBottom: true }, { children: "Kognition smart build" })), jsx(Typography, __assign({ variant: "caption", gutterBottom: true }, { children: "Turn off for manual settings" }))] }), jsx(Switch, {})] }))] })));
};
var KpModal = function (_a) {
    ...
    var _d = React__default.useState(isOpen), open = _d[0], setOpen = _d[1];
    useEffect(function () {
    ...
    return (jsx(Stack, { children: jsx(Modal, __assign({ open: open, componentsProps: { backdrop: { style: { backgroundColor: "#1E2332", opacity: '0.6' } } }, onClose: handleClose, "aria-labelledby": "modal-modal-title", "aria-describedby": "modal-modal-description" }, { children: jsxs(Box$1, __assign({ sx: style }, { children: [jsxs(Box$1, __assign({ sx: { display: "flex", flexDirection: "row", alignItems: "center", mb: 2 } }, { children: [jsx(Typography, __assign({ id: "transition-modal-title", variant: "h5", component: "div", sx: { color: "#1E2332", ml: 3, mb: 1, fontFamily: 'Inter', fontSize: "20px", fontWeight: "600", textOverflow: "ellipsis" } }, { children: title })), isHeaderContent &&
                                jsx(Container, { children: headerContent })] })), jsx(Divider, { variant: "fullWidth", flexItem: true }), jsxs("form", __assign({ onSubmit: onAcceptanceClick }, { children: [jsx(Container, __assign({ sx: { mt: 2, mr: 3 } }, { children: content })), jsx(Stack, __assign({ direction: "row-reverse", spacing: 1, mt: 1, mr: 3 }, { children: jsxs(Fragment, { children: [" ", type === MODALTYPE.DEFAULT ? (jsxs(Fragment, { children: [jsx(KpButton, __assign({ type: "submit" }, submitButtonProps, { children: submitBtnText })), jsx(KpButton, __assign({}, cancelButtonProps, { children: cancelBtnText }))] })) : (jsx(KpButton, __assign({ type: "submit" }, submitButtonProps, { children: submitBtnText })))] }) }))] })), isFooterContent ?
                        jsx(Container, __assign({ sx: { mt: 2, mr: 2 } }, { children: footerContent })) : null] })) })) }));
};

var KpStepper = forwardRef(function (_a, ref) {
    ...
    var StepperUnselect = styled$4("div")(function (_a) {
    ...
    var StepperSelect = styled$4("div")(function (_a) {
        _a.theme;
        return ({
    ...
    var SpanSelect = styled$4("span")(function (_a) {
        _a.theme;
        return ({
            fontFamily: "Inter",
            fontSize: "14px",
    ...
    var StepperComponent = styled$4(Box$1)(function (_a) {
        _a.theme;
        return ({
            width: width,
        });
    ...
    var _b = React__default.useState(0), activeStep = _b[0], setActiveStep = _b[1];
    var _c = React__default.useState({}), completed = _c[0]; _c[1];
    ...
    useImperativeHandle(ref, function () { return ({ onBack: onBack, onNext: onNext }); });
    ...
    jsx(StepperComponent, { children: jsx(Stepper, __assign({ nonLinear: true, activeStep: currentStep === undefined ? activeStep : currentStep }, { children: steps.map(function (step, index) { return (jsx(Step, __assign({ sx: { paddingRight: '0px', paddingLeft: '0px' }, completed: completed[index] }, { children: currentStep === undefined ? (activeStep) : currentStep !== index ? (jsx(StepperUnselect, __assign({ indexValue: index, onClick: function () { return handleStep(index); } }, { children: index + 1 }))) : (jsxs(StepperSelect, __assign({ onClick: handleStep(index) }, { children: [jsx(SpanSelect, { children: index + 1 }), step.label] }))) }), step.label)); }) })) }));
});
...
var KpAccordion = function (_a) {
    ...
    var _b = React__default.useState(activeAccordionIds || []), expanded = _b[0], setExpanded = _b[1];
    useEffect(function () {
        if (onChange) {
            onChange(expanded);
        }
    ...
    return (jsx(Box, __assign({ sx: { display: 'flex', flexDirection: 'column', gap: '16px' } }, { children: accordionContent.map(function (item, index) { return (jsxs(Accordion, __assign({ expanded: expanded.includes(item.id), onChange: handleChange(item.id), sx: {
            ...
            }, disableGutters: true }, { children: [jsx(AccordionSummary, __assign({ sx: { borderBottom: 'none', flexDirection: isExpandMoreLeft ? 'row-reverse' : 'row' }, expandIcon: jsx(ExpandMoreIcon, {}) }, { children: jsx(Typography$1, __assign({ sx: { fontSize: '1rem', fontWeight: '700', fontFamily: 'Inter' } }, { children: item.accordionTitle })) })), jsxs(AccordionDetails, __assign({ sx: { borderTop: border, borderColor: item.accordionborderColor } }, { children: [item.accordionContent && (jsx(Fragment, { children: item.accordionContent })), item.accordionSubContent && (jsx(KpAccordion, { activeAccordionIds: activeAccordionIds, accordionContent: item.accordionSubContent }))] }))] }), index)); }) })));
};
...
var KpDraggableList = function (_a) {
    ...
    var _b = useState(items.sort(function (a, b) { return a.fieldOrder - b.fieldOrder; })), listItems = _b[0], setListItems = _b[1];
    var _c = useState(listItems[listItems.length - 1]), previousStateLastItem = _c[0], setPreviousStateLastItem = _c[1];
    var _d = useState(listItems[listItems.length - 1].visible), previousStateLastItemVisibility = _d[0], setLastItemVisibility = _d[1];
    var _e = useState(), isDragging = _e[0], setIsDragging = _e[1];
    ...
    return (jsx("div", __assign({ className: "draggable-list-container", ref: containerRef, style: {
            pointerEvents: disabled ? "none" : "unset",
        } }, { children: listItems.map(function (item, index) {
            // Filter out undefined index values
            return index !== undefined && (jsx("div", { children: jsxs(ListItem$1, __assign({ onMouseDown: function (e) { return dragStart(e, index); }, className: generateListItemClassName(isDragging === index, item.visible) }, { children: [jsx(DragIndicatorIcon, { className: "draggable-list-item-button-drag" }), jsx(ListItemText$1, { primary: item.content, className: "draggable-list-item-text" }), enableVisibility ? (item.visible ? (jsx(VisibilityIcon, { className: "draggable-list-item-button-view", onClick: function () { return toggleVisibility(index); } })) : (jsx(VisibilityOffIcon, { className: "draggable-list-item-button-view", onClick: function () { return toggleVisibility(index); } }))) : null] }), item.fieldId) }));
        }) })));
};
...
var TableHeaderComponent = function (_a) {
    ...
    var _b = useState(false), isFilterOpen = _b[0], setIsFilterOpen = _b[1];
    var _c = useState(0), filterItemsHeight = _c[0], setFilterItemsHeight = _c[1];
    var _d = useState(""); _d[0]; _d[1];
    var onClickFilter = function () {
        setIsFilterOpen(!isFilterOpen);
    };
    var _e = useState(filterValues || []), filterData = _e[0], setFilterData = _e[1];
    var filterItemsWrapperRef = useCallback(function (node) {
        if (node !== null) {
    ...
    var renderDropDownContent = function (value) {
        if (Array.isArray(value)) {
            return value.map(function (item, index) { return jsx(MenuItem, __assign({ disabled: item === 'Select an option', value: item }, { children: item }), index); });
        }
    };
    var setFilterContent = function () {
        return (jsx(Fragment, { children: jsx(FormGroup, { children: filterData.map(function (item, index) {
                    var _a, _b;
                    switch (item.type) {
                        case 'CHECK_BOX':
                            return jsx(FormControl, { children: jsx(FormControlLabel, { control: jsx(Checkbox, { sx: (_a = {},
                                            _a["&, &.".concat(checkboxClasses.colorPrimary)] = {
                                                color: '#C1C4CD',
                                            },
                                            _a["&, &.".concat(checkboxClasses.checked)] = {
                                                color: '#253378',
                                            },
                        ...
                        case 'DROP_DOWN':
                            return jsxs(FormControl, __assign({ size: 'small', sx: { borderColor: 'red' } }, { children: [jsx(FormControlLabel, { control: jsx(Checkbox, { sx: (_b = {},
                                                _b["&, &.".concat(checkboxClasses.colorPrimary)] = {
                                                    color: '#C1C4CD',
                                                },
                                                _b["&, &.".concat(checkboxClasses.checked)] = {
                                                    color: '#253378',
                                                },
                                                _b), name: "subscribe", checked: item.isChecked, onChange: function (e) { onFilterItemClick(item, e.target.checked); } }), label: item.name }), jsx(Select, __assign({ sx: {
                                            '.MuiOutlinedInput-notchedOutline': {
                                                borderColor: "#C1C4CD",
                                            },
                                            '&.Mui-focused .MuiOutlinedInput-notchedOutline': {
    ...
    return (jsx(Fragment, { children: jsxs(Grid, __assign({ container: true, spacing: 1, sx: { padding: "10px" } }, { children: [jsx(Grid, __assign({ item: true, xs: 8 }, { children: jsx(Typography, __assign({ variant: "h6", id: "tableTitle", sx: {
                            color: '#666C7F',
                            fontSize: 20,
                            fontWeight: 600,
                            fontFamily: "Inter"
                        } }, { children: tableTitle })) })), jsxs(Grid, __assign({ sx: { display: 'flex' }, item: true, xs: 4 }, { children: [typeof searchOnButtonClick !== "undefined" && searchOnButtonClick ? (jsx(TextField$1, { onChange: function (e) {
                                ...
                                endAdornment: (jsx(IconButton$1, __assign({ onClick: function () { return onSearchButtonClick && onSearchButtonClick(); } }, { children: jsx(SearchOutlinedIcon, { sx: { color: "#9E9E9E", fontSize: "18px" } }) }))),
                            }, InputLabelProps: { sx: { color: '#9E9E9E', fontSize: '14px', fontFamily: "Inter" } } })) : (jsx(TextField$1, { onChange: function (e) { onSearchTermChange && onSearchTermChange(e.target.value); }, id: "search", label: "Search", size: "small", variant: "outlined", sx: __assign({}, inputStyles), fullWidth: true, InputProps: {
                                endAdornment: (jsx(IconButton$1, { children: jsx(SearchOutlinedIcon, { sx: { color: "#9E9E9E", fontSize: "18px" } }) })),
                            }, InputLabelProps: {
                                sx: { color: "#9E9E9E", fontSize: "14px", fontFamily: "Inter" },
                            } })), isFilterEnabled &&
                            jsxs(Box, __assign({ sx: { position: 'relative', width: '200px', marginLeft: '20px', display: 'flex', alignItems: 'center' } }, { children: [jsxs(Box, __assign({ sx: { display: 'flex', alignItems: 'center' }, onClick: onClickFilter }, { children: [jsx(Typography, __assign({ sx: { cursor: 'pointer', marginRight: '10px' }, fontWeight: 600, fontSize: '12px', letterSpacing: '1px', lineHeight: '18px', color: '#666C7F' }, { children: "FILTER BY" })), isFilterOpen ? jsx(ExpandLess, {}) : jsx(ExpandMore, {})] })), isFilterOpen &&
                                        jsxs(Box, __assign({ sx: {
                                                position: 'absolute',
                                                display: 'flex',
                                                flexDirection: 'column',
                                                justifyContent: 'space-between',
                                                ...
                                                overflow: 'auto',
                                                padding: '8px',
                                            } }, { children: [jsxs(Box, __assign({ sx: {} }, { children: [jsx(KpFormInput, { hasIcon: true, helperText: "Helper text", label: "Label", maxChars: 100, 
                                                            // onChange={() => { console.log('search 1') }}
                                                            // onClick={() => { console.log('search 2') }}
                                                            placeholder: "Search...", size: "small" }), jsx(Box, __assign({ sx: { margin: '1rem', height: "270px", overflow: 'auto' } }, { children: setFilterContent() }))] })), jsxs(Box, __assign({ sx: {
                                                        // flexGrow: '1',
                                                        height: '50px',
                                                        alignSelf: 'flex-end',
                                                        display: 'flex',
                                                        ...
                                                        gap: '1rem',
                                                        padding: '8px',
                                                    } }, { children: [jsx(KpButton, { buttonColor: "Primary", customStyle: {}, iconColor: "#fff", label: "CLEAR", leftIcon: "Mode", leftIconSize: 0.9, leftIconType: "MUI", onClick: function () {
                                                                clearFilter();
                                                                setIsFilterOpen(false);
                                                            }, rightIcon: "ArrowForwardIos", rightIconSize: 0.9, rightIconType: "MUI", size: "small", variant: "Tertiary" }), jsx(KpButton, { buttonColor: "Primary", customStyle: {}, iconColor: "#fff", label: "APPLY", leftIcon: "Mode", leftIconSize: 0.9, leftIconType: "MUI", onClick: function () {
                    ...
                    jsxs(Grid, __assign({ ref: filterItemsWrapperRef, item: true, sx: { width: '100%', padding: '1rem 0.5rem !important', display: 'flex', flexWrap: 'wrap', gap: '10px', alignItems: 'center' } }, { children: [filterData.map(function (chip) {
                                return (jsxs(Fragment, { children: [chip.isChecked &&
                                            chip.selectedValue !== 'Select an option' && chip.type === 'DROP_DOWN' ?
                                            jsx(Chip, { variant: "outlined", label: chip.name + ' - ' + chip.selectedValue, onDelete: function () { return deleteChip(chip); } }, chip.id)
                                            : null, chip.isChecked && chip.type === 'CHECK_BOX' && jsx(Chip, { variant: "outlined", label: chip.name, onDelete: function () { return deleteChip(chip); } }, chip.id)] }));
                            }), filterData.find(function (item) { return item.isChecked === true; }) !== undefined &&
                                jsx(Box, __assign({ onClick: function () { clearFilter(); }, sx: { fontFamily: 'Inter', color: '#253378', fontSiz: '14px', textDecoration: 'underline', cursor: 'pointer' } }, { children: "clear all" }))] }))] })) }));
};

var StyledGridOverlay = styled$4('div')(function (_a) {
    var theme = _a.theme;
    return ({
        display: 'flex',
        flexDirection: 'column',
...
function CustomNoRowsOverlay() {
    return (jsxs(StyledGridOverlay, { children: [jsx("svg", __assign({ width: "120", height: "100", viewBox: "0 0 184 152", "aria-hidden": true, focusable: "false" }, { children: jsxs("g", __assign({ fill: "none", fillRule: "evenodd" }, { children: [jsxs("g", __assign({ transform: "translate(24 31.67)" }, { children: [jsx("ellipse", { className: "ant-empty-img-5", cx: "67.797", cy: "106.89", rx: "67.797", ry: "12.668" }), jsx("path", { className: "ant-empty-img-1", d: "M122.034 69.674L98.109 40.229c-1.148-1.386-2.826-2.225-4.593-2.225h-51.44c-1.766 0-3.444.839-4.592 2.225L13.56 69.674v15.383h108.475V69.674z" }), jsx("path", { className: "ant-empty-img-2", d: "M33.83 0h67.933a4 4 0 0 1 4 4v93.344a4 4 0 0 1-4 4H33.83a4 4 0 0 1-4-4V4a4 4 0 0 1 4-4z" }), jsx("path", { className: "ant-empty-img-3", d: "M42.678 9.953h50.237a2 2 0 0 1 2 2V36.91a2 2 0 0 1-2 2H42.678a2 2 0 0 1-2-2V11.953a2 2 0 0 1 2-2zM42.94 49.767h49.713a2.262 2.262 0 1 1 0 4.524H42.94a2.262 2.262 0 0 1 0-4.524zM42.94 61.53h49.713a2.262 2.262 0 1 1 0 4.525H42.94a2.262 2.262 0 0 1 0-4.525zM121.813 105.032c-.775 3.071-3.497 5.36-6.735 5.36H20.515c-3.238 0-5.96-2.29-6.734-5.36a7.309 7.309 0 0 1-.222-1.79V69.675h26.318c2.907 0 5.25 2.448 5.25 5.42v.04c0 2.971 2.37 5.37 5.277 5.37h34.785c2.907 0 5.277-2.421 5.277-5.393V75.1c0-2.972 2.343-5.426 5.25-5.426h26.318v33.569c0 .617-.077 1.216-.221 1.789z" })] })), jsx("path", { className: "ant-empty-img-3", d: "M149.121 33.292l-6.83 2.65a1 1 0 0 1-1.317-1.23l1.937-6.207c-2.589-2.944-4.109-6.534-4.109-10.408C138.802 8.102 148.92 0 161.402 0 173.881 0 184 8.102 184 18.097c0 9.995-10.118 18.097-22.599 18.097-4.528 0-8.744-1.066-12.28-2.902z" }), jsxs("g", __assign({ className: "ant-empty-img-4", transform: "translate(149.65 15.383)" }, { children: [jsx("ellipse", { cx: "20.654", cy: "3.167", rx: "2.849", ry: "2.815" }), jsx("path", { d: "M5.698 5.63H0L2.898.704zM9.259.704h4.985V5.63H9.259z" })] }))] })) })), jsx(Box$1, __assign({ sx: { mt: 1 } }, { children: "No Data" }))] }));
}
...
var TableComponent = function (_a) {
    ...
    var _b = useState(), orderByValue = _b[0], setOrderByValue = _b[1];
    var _c = React__default.useState('asc'), order = _c[0], setOrder = _c[1];
    var _d = React__default.useState('calories'), orderBy = _d[0], setOrderBy = _d[1];
    var _e = useState({}), anchorElMap = _e[0], setAnchorElMap = _e[1];
    var _f = React__default.useState(Array.isArray(selectedList) ? allowMultiSelect ? selectedList : [selectedList[0]] : []), selected = _f[0], setSelected = _f[1];
    ...
    return (jsxs(Fragment, { children: [jsx(TableHead, { children: jsxs(TableRow, { children: [tableSelection && (jsx(TableCell, __assign({ padding: "checkbox" }, { children: jsx(Checkbox, { color: selectionColor === "info" ? 'info' : selectionColor, sx: selectionColor === "info"
                                    ? {
                                        color: "#253378",
                                        "&.Mui-checked": {
                                            color: "#253378",
                                ...
                                }, disabled: !allowMultiSelect }) }))), tableHeaders === null || tableHeaders === void 0 ? void 0 : tableHeaders.map(function (headCell) { return (jsx(TableCell, __assign({ sx: {
                                textAlign: 'left',
                                color: '#666C7F',
                                fontSize: '12px',
                                fontWeight: 700,
                                lineHeight: '18px',
                                fontFamily: "Inter"
                            }, sortDirection: orderByValue === headCell.id ? order : false }, { children: jsxs(TableSortLabel, __assign({ active: orderByValue === headCell.id, direction: orderByValue === headCell.id ? order : 'asc', onClick: createSortHandler(headCell.id), IconComponent: order === 'desc' ? ArrowDropDownIcon : ArrowDropUpIcon }, { children: [headCell.label, orderByValue === headCell.id ? (jsx(Box, __assign({ component: "span", sx: visuallyHidden$1 }, { children: order === 'desc' ? 'sorted descending' : 'sorted ascending' }))) : null] })) }), headCell.id)); }), jsx(TableCell, __assign({ sx: {
                                textAlign: 'right',
                                color: '#666C7F',
                                fontSize: '12px',
                                fontWeight: 700,
                                lineHeight: '18px',
                                fontFamily: "Inter"
                            } }, { children: "Actions" }))] }) }), jsxs(TableBody, { children: [rows && rows.map(function (row, index1) {
                        var isItemSelected = isSelected(row.id);
                        var labelId = "enhanced-table-checkbox-".concat(index1);
                        return (jsxs(TableRow, __assign({ sx: {
                                padding: '8px !important',
                            }, hover: true }, { children: [tableSelection && (jsx(TableCell, __assign({ padding: "checkbox" }, { children: jsx(Checkbox, { color: selectionColor === "info" ? 'info' : selectionColor, sx: selectionColor === "info"
                                            ? {
                                                color: "#253378",
                                                "&.Mui-checked": {
                                                    color: "#253378",
                                    ...
                                    if (hideIdColumn && val[0] === "id")
                                        return;
                                    return jsx(TableCell, __assign({ align: 'left', sx: { fontFamily: "Inter", padding: "8px", maxWidth: typeof maxTableDataWidth !== "undefined" ? "".concat(maxTableDataWidth, "px") : "unset", wordBreak: typeof maxTableDataWidth !== "undefined" ? "break-word" : "unset" } }, { children: val[1] }), index2);
                                }), jsxs(TableCell, __assign({ sx: { padding: "8px" }, align: 'right' }, { children: [jsx(Fragment, { children: customBtnsAllowed && (jsx(Fragment, { children: row === null || row === void 0 ? void 0 : row.customButtons })) }), jsx(Fragment, { children: editAllowed && (jsx(Tooltip, __assign({ title: "Edit" }, { children: jsx(IconButton, __assign({ "aria-label": "edit", sx: { cursor: 'pointer' }, onClick: function (e) { return editClicked(row); } }, { children: jsx(ModeOutlined, { fontSize: "small" }) })) }))) }), jsx(Fragment, { children: deleteAllowed && (jsx(Tooltip, __assign({ title: "Delete" }, { children: jsx(IconButton, __assign({ "aria-label": "delete", sx: { cursor: 'pointer' }, onClick: function (e) { return deleteClicked(row); } }, { children: jsx(DeleteOutlineOutlined, { fontSize: "small" }) })) }))) }), jsx(Fragment, { children: viewAllowed && (jsx(Tooltip, __assign({ title: "View" }, { children: jsx(IconButton, __assign({ "aria-label": "view", sx: { cursor: 'pointer' }, onClick: function (e) { return viewClicked(row); } }, { children: jsx(VisibilityOutlined, { fontSize: "small" }) })) }))) }), jsx(Fragment, { children: menuAllowed && (jsxs(Fragment, { children: [jsx(IconButton, __assign({ "aria-label": "more", id: "long-button", "aria-haspopup": "true", onClick: function (e) { return handleMenuOpen(e, row.id); } }, { children: jsx(MoreVertIcon, {}) })), jsxs(Menu, __assign({ anchorEl: anchorElMap[row.id], open: Boolean(anchorElMap[row.id]), onClose: function (e) { return handleMenuClose(row.id); }, anchorOrigin: {
                                                            vertical: 'bottom',
                                                            horizontal: 'right',
                                                        }, transformOrigin: {
                                                            vertical: 'top',
                                                            horizontal: 'right',
                                                        }, PaperProps: { style: { minWidth: '8rem' } } }, { children: [jsx(MenuItem$1, __assign({ onClick: function (e) { return menuItemClicked && menuItemClicked(row, "VIEW"); } }, { children: "View" })), jsx(MenuItem$1, __assign({ onClick: function (e) { return menuItemClicked && menuItemClicked(row, "EDIT"); } }, { children: "Edit" })), jsx(MenuItem$1, __assign({ onClick: function (e) { return menuItemClicked && menuItemClicked(row, "DELETE"); } }, { children: "Delete" }))] }))] })) })] }))] }), index1));
                    }), !(rows === null || rows === void 0 ? void 0 : rows.length) && (jsx(TableRow, { children: jsx(TableCell, __assign({ colSpan: 12 }, { children: jsx(CustomNoRowsOverlay, {}) })) }))] })] }));
};
...
var TablePaginationActions = function (props) {
    ...
    return (jsx(Box$1, { children: jsxs(Stack, __assign({ direction: "row", spacing: 2 }, { children: [jsxs(Box$1, __assign({ sx: { display: "flex", alignItems: "center" } }, { children: [jsx(Typography$1, __assign({ sx: { color: "#666C7F", fontSize: "14px", fontFamily: "Inter" } }, { children: "Rows per page :" })), jsx(Select, __assign({ defaultValue: rowsPerPage, sx: {
                                boxShadow: "none",
                                ".MuiOutlinedInput-notchedOutline": { border: 0 },
                                fontFamily: "Inter",
                                fontSize: "14px",
                            }, onChange: handleRowsPerPage, value: rowsPerPage }, { children: rowsPerPageOptions.map(function (item, i) {
                                return (jsx(MenuItem, __assign({ value: item, sx: { fontFamily: "Inter", fontSize: "14px" } }, { children: item }), i));
                            }) }))] })), jsx(Typography$1, __assign({ sx: {
                        paddingTop: "18px",
                        color: "#666C7F",
                        fontSize: "14px",
                        fontFamily: "Inter",
                        ...
                        "".concat(page * rowsPerPage > totalNumberOfData
                            ...
                            : page * rowsPerPage) +
                        "   of   " +
                        "".concat(totalNumberOfData) })), jsx(IconButton$1, __assign({ onClick: handleFirstPageButtonClick, disabled: page === 1, "aria-label": "first page" }, { children: theme.direction === "rtl" ? jsx(LastPageIcon, {}) : jsx(FirstPageIcon, {}) })), jsx(IconButton$1, __assign({ onClick: handleBackButtonClick, disabled: page === 1, "aria-label": "previous page" }, { children: theme.direction === "rtl" ? (jsx(KeyboardArrowRight, {})) : (jsx(KeyboardArrowLeft, {})) })), jsx(Select, __assign({ defaultValue: page, sx: {
                        boxShadow: "none",
                        ".MuiOutlinedInput-notchedOutline": { border: 0 },
                        fontFamily: "Inter",
                        fontSize: "14px",
                    }, onChange: handlePageNumberSelect, value: page }, { children: __spreadArray([], Array(noOfPages), true).map(function (e, i) {
                        return (jsx(MenuItem, __assign({ value: i + 1, sx: { fontFamily: "Inter", fontSize: "14px" } }, { children: i + 1 }), i + 1));
                    }) })), jsx(IconButton$1, __assign({ onClick: handleNextButtonClick, disabled: page >= Math.ceil(totalNumberOfData / rowsPerPage), "aria-label": "next page" }, { children: theme.direction === "rtl" ? (jsx(KeyboardArrowLeft, {})) : (jsx(KeyboardArrowRight, {})) })), jsx(IconButton$1, __assign({ onClick: handleLastPageButtonClick, disabled: page >= Math.ceil(totalNumberOfData / rowsPerPage), "aria-label": "last page" }, { children: theme.direction === "rtl" ? jsx(FirstPageIcon, {}) : jsx(LastPageIcon, {}) }))] })) }));
};

var customBtn = function () {
    return (jsx(KpButton, { buttonColor: "Primary", customStyle: {}, iconColor: "#fff", label: "PAUSE", leftIcon: "Mode", leftIconSize: 0.9, leftIconType: "MUI", onClick: function noRefCheck() { }, rightIcon: "ArrowForwardIos", rightIconSize: 0.9, rightIconType: "MUI", size: "default", variant: "Tertiary" }));
};
var COLOR;
(function (COLOR) {
...
var KpTable = function (_a) {
    ...
    var _c = useState(rowsPerPage), pageSize = _c[0], setPageSize = _c[1];
    var _d = useState(0), filterItemsHeight = _d[0], setFilterItemsHeight = _d[1];
    ...
    return (jsx(Box$1, __assign({ sx: { width: "100%" } }, { children: jsxs(Paper, __assign({ elevation: 0, sx: { width: "100%", borderRadius: "6px", border: "1px solid #E0E1E6" } }, { children: [jsx(TableHeaderComponent, { tableTitle: tableTitle, onSearchTermChange: onChangeSearchValue, isFilterEnabled: isFilterEnabled || false, filterValues: filterValues || [], maxHeight: maxHeight, onFilterApply: onFilterApply, onFilterItemsHeightChange: setFilterItemsHeight, searchOnButtonClick: searchOnButtonClick, onSearchButtonClick: onSearchButtonClick, searchQueryValue: searchQueryValue }), jsx(TableContainer, __assign({ sx: { maxHeight: maxHeight - filterItemsHeight } }, { children: jsx(Table, __assign({ sx: { minWidth: 650 }, stickyHeader: true, "aria-label": "sticky table" }, { children: jsx(TableComponent, { tableHeaders: tableHeaders, rows: rows, viewAllowed: isViewAllow, editAllowed: isEditAllow, deleteAllowed: isDeleteAllow, menuAllowed: isMenuAllow, editClicked: onEditClicked, customBtnsAllowed: isCustomIconsAllowed, viewClicked: onViewClicked, deleteClicked: onDeleteClicked, onRequestSort: onRequestSort, menuItemClicked: onMenuItemClicked, onRowSelect: onRowSelect, tableSelection: tableSelection, allowMultiSelect: allowMultiSelect, hideIdColumn: hideIdColumn, selectedList: selectedList, selectionColor: selectionColor, maxTableDataWidth: maxTableDataWidth, onSortData: onSortData }) })) })), jsx(TableFooter, __assign({ sx: { display: "flex", width: "100%", justifyContent: "flex-end" } }, { children: jsx(TablePaginationActions, { component: "div", showFirstButton: true, showLastButton: true, totalNumberOfData: totalNumberOfData, rowsPerPage: pageSize, page: page, rowsPerPageOptions: rowsPerPageOptions, onPageChange: handleChangePage, onPageNumberChange: onPageNumberChangeAction, onLastPageButtonClick: onLastPageButtonClick, onNextButtonClick: onNextButtonClick, onFirstPageClick: onFirstPageClick, onBackButtonClick: onBackButtonClick, onRowsPerPageChange: handleChangeRowsPerPage }) }))] })) })));
};

export { ButtonColor, COLOR, ICONS, Icon, IconSide, IconType, KpAccordion, KpAlert, KpBadge, KpButton, KpDraggableList, KpFormInput, KpFormSelect, KpHeader, KpLabel, KpLogo, KpModal, KpOverview, KpSidebar, KpSnackbar, KpStepper, KpTable, KpTabs, KpTooltip, MODALTYPE, MODALVARIANT, ModalButtonColor, ModalIconType, ModalTestJSXElementOne, ModalTestJSXElementTwo, ModelTestFooterElement, ModelTestHeaderElement, STATUS, TestJSXElementOne, TestJSXElementTwo, VARIANT, VARIANTS, customBtn, sampleInnerComponent, sampleInnerTooltipComponent, tabImageJSX, tabJsxElement };
